...
```bash
git remote add encore encore://magna-ai-business-platform-zpw2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/magna-ai-business-platform-zpw2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/magna-ai-business-platform-zpw2/settings/integrations/github)
